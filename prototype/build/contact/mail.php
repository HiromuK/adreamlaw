...
$site_top = "http://a-dreamlaw.com//";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@adreamlaw.com";
...
$Referer_check_domain = "a-dreamlaw.com";
...
$require = array('お名前','参加人数','電話番号','Email');
...
$re_subject = "建築・不動産のトラブル対策セミナーへの参加申込ありがとうございました。";
...
セミナーへの参加申込のお問い合わせありがとうございました。
１〜２営業日以内にスタッフよりご連絡いたしますので、今しばらくお待ちください。
...
──────────────────────
弁護士法人淡路町ドリーム
〒101-0063 東京都千代田区神田淡路町1-2 　クリスタルビル3F 4F 8F　
TEL（お問い合わせ）：03- 3525 - 8010　TEL（一般）：03- 3255 - 1090 　FAX：03- 5298 - 6170
E-mail:info@adreamlaw.com
URL: http://a-dreamlaw.com/
──────────────────────
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('電話番号','参加人数','金額','FAX');
